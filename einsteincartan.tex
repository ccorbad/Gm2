...
\end{equation}
where $d^Dx\,|\hat{e}| = d^Dx\,\sqrt{|\hat{g}|}$ is the covariant volume element, $|\hat{e}|=\det{\left(\vih^{\hat{a}}_{\hat{\mu}}\right)}$ is the determinant of the $D$-dimensional vielbein and
\begin{equation}
\label{covder}
