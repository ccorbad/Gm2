...
In this section a brief description of Cartan-Einstein Formalism (CEF) of gravity  \pro{is presented}. The CEF is constructed in more general  \pro{grounds than the} Einstein-Hilbert one. Spin connection and vielbeins are independent  \pro{fields and therefore torsion might not vanish}. Including torsion  implies \pro{the existence of an}  antisymmetric part of the affine connection
\begin{align}
