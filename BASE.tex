...
\begin{abstract}
  The aim of this article is to explore one-loop observables due the four fermion interaction in a effective theory coming from the torsionful extra dimension scenario. The results are compared with Standard Model precision tests, allowing to constraint strongly the scale for new physics and the parameters of the model.
\end{abstract}
