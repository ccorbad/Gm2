...
\end{align}
and the effects of the Beyond the Standard Model physics has to be included in the difference between the theoretical value and the experimental one.

This leads to the equation $\Gamma_{\text{teo}} - \Gamma_{\text{exp}}\geq \delta\Gamma_{\text{4FI}}$. Restricting only to positive energy scales, and neglecting the scales excluded by the experiments (see Ref.~\cite{Chatrchyan:2013muj}), the  equation has solution for
\begin{eqnarray}
      ...
      \begin{tikzpicture}[baseline,trim axis left,trim axis right]
        \begin{axis}[
          ...
          \addplot[very thick,
            ...
            domain=1e4:8e4,
            samples=301,
          ] { 1.457e-8*1.64 } |- (axis cs:2000,-1e-9);
          \addplot[very thick,
            blue,
            domain=1e4:8e4,
            samples=301,
